...
public class CurrentRoomDetectionPostProcessing : DungeonGeneratorPostProcessingComponentGrid2D {
  public override void Run(DungeonGeneratorLevelGrid2D level) {
    Debug.Log("Generating rooms floor triggers...");
    ...
    Debug.Log("Done generating floor triggers");
  }
