    ...
    public class DungeonManager : MonoBehaviour
    {
        ...
        public void MoveToRoom(DoorDirection doorDir)
        {
            ...
            if (_dungeonMap.TryGetValue(_currentCoords, out RoomInstance oldRoom))
            {
                ...
                foreach (var obj in oldRoom.RoomObjects) obj.SetActive(false);
            }
            ...
            if (_dungeonMap.ContainsKey(nextCoords))
            {
                ...
                if (encounterManager != null) encounterManager.ClearCorpses(); 
                ...
                if (_dungeonMap.TryGetValue(_currentCoords, out RoomInstance newRoom))
                {
                    ...
                    foreach (var obj in newRoom.RoomObjects) obj.SetActive(true);
                }
            }
        }
        ...
        public void GenerateNextLevel()
        {
            ...
            {
                foreach (var obj in room.RoomObjects) if (obj != null) Destroy(obj);
        ...
        private Vector2Int GetRandomDirectionVector()
        {
            ...
            return r switch {
                0 => Vector2Int.up, 1 => Vector2Int.down, 2 => Vector2Int.left, _ => Vector2Int.right
            };
        }
