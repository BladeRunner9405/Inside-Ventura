...
public abstract class Weapon : Artifact 
{
    ...
    [SerializeField] public int baseChainCount = 3;
    [SerializeField] public float baseComboWindow = 0.5f;
    
    [Header("Critical Hit")] 
    [SerializeField] [Range(0f, 1f)] public float baseCritChance = 0.1f;
    [SerializeField] public float baseCritMultiplier = 1.5f;
