...
using UnityEngine;
  ...
  public class Player : Entity
  {
      ...
      [SerializeField] private AimTarget playerAim; // Перенесено из контроллера
      ...
      public override float MaxHealth
      {
          get
          {
              ...
              float heartBonus = (Equipment != null && Equipment.Heart != null) 
      ...
      {
          if (itemPickup != null) itemPickup.TryToInteract();
      }
