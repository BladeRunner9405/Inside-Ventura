...
{
  [SerializeField]
  private float intensity = 3f; // Это размах движений камеры

  [SerializeField]
  private float frequency = 2f; // Это скорость этих движений. Как много колебаний (рывков туда-сюда) камера совершает за одну секунду.
